  ...
  return (
    <>
      ...
      <main>
        <Hero />
        {/* About Section */}
        <section className="py-14 px-2 sm:py-24 sm:px-4 bg-green-50">
          <div className="mx-auto max-w-6xl">
            <div className="mb-8 text-center sm:mb-16">
              <h2 className="text-2xl font-extrabold text-foreground mb-2 sm:text-4xl sm:mb-4">
            ...
            <div className="flex flex-col gap-8 sm:gap-16 md:flex-row md:items-center">
              <div className="flex-1 min-w-0 flex flex-col justify-center items-center sm:items-start">
                <h3 className="text-lg font-bold text-foreground mb-2 text-center sm:text-3xl md:text-4xl sm:text-left">
                  Transforming Lives Through Nutrition
                </h3>
                <div className="space-y-3 sm:space-y-5 align-center">
                  <p className="text-[13px] text-foreground/70 text-balance sm:text-lg ">
                    We work with the vision to ease complications related to
                    diseases, diagnosis, or lifestyle modifications.
                    <br className="block sm:hidden" />
                    Our purpose is to serve nutrition in its best way as
                    preventive care before you may face any complicated health
                    issues.
                  </p>
                  <p className="text-[13px] text-foreground/70 text-balance sm:text-lg ">
                    Whether you are managing a chronic condition, looking to
                    lose weight, or simply want to adopt a healthier lifestyle,
