...
export default function Hero() {
  return (
    <>
      ...
      <section className="relative overflow-hidden px-4 py-16 sm:py-20 lg:py-24 bg-white">
        <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center text-center">
          ...
          <p className="mt-4 max-w-3xl text-[15px] leading-relaxed text-foreground/70 sm:mt-6 sm:text-lg md:text-xl">
            Personalized diet plans, expert nutritional guidance, and
            disease-specific programs crafted just for you. Get meal plans that
            fit your lifestyle and show results fast.
          </p>
