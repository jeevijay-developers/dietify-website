...
export default function WhyChoose() {
  return (
    <section className="py-10 px-2 sm:py-20 sm:px-4 bg-white">
            ...
            <div className="space-y-5">
              <div className="flex gap-3 items-center bg-primary/5 rounded-lg px-3 py-3">
                ...
                <div className="flex flex-col items-start text-left">
                  <h3 className="font-semibold text-base mb-1 text-foreground text-left">
                    Disease-Specific Programs
                  </h3>
                  <p className="text-[14px] text-foreground/70 text-left">
                    Specialized diet plans for diabetes, PCOS, thyroid, and more
                  </p>
                </div>
              </div>
              <div className="flex gap-3 items-center bg-primary/5 rounded-lg px-3 py-3">
                ...
                <div className="flex flex-col items-start text-left">
                  ...
                  <p className="text-[14px] text-foreground/70 text-left">
                    Direct access to certified dieticians via online video calls
                  </p>
                </div>
              </div>
              <div className="flex gap-3 items-center bg-primary/5 rounded-lg px-3 py-3">
                ...
                <div className="flex flex-col items-start text-left">
                  ...
                  <p className="text-[14px] text-foreground/70 text-left">
                    Regular follow-ups and plan adjustments based on your
                    progress
                  </p>
                </div>
              </div>
              <div className="flex gap-3 items-center bg-primary/5 rounded-lg px-3 py-3">
                ...
                <div className="flex flex-col items-start text-left">
                  ...
                  <p className="text-[14px] text-foreground/70 text-left">
                    Easy-to-follow recipes and shopping lists for real-world
                    implementation
                  </p>
                </div>
              </div>
